...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/logout', 'Admin\LoginController@logout')->name('admin.logout2');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/index_s', 'Front\FrontendController@index_s')->name('front.index_s');
  Route::get('/extras_s', 'Front\FrontendController@extraIndex_s')->name('front.extraIndex_s');  
  ...
  Route::get('/category_s/{category?}/{subcategory?}/{childcategory?}','Front\CatalogController@category_s')->name('front.category_s');
  ...
  Route::get('/item_s/{slug}','Front\CatalogController@product_s')->name('front.product_s');
  ...
  Route::get('/item/view/review_s/{id}','Front\CatalogController@reviews_s')->name('front.reviews_s');
  // PRODCT SECTION ENDS
  ...
  Route::get('/carts_s/','Front\CartController@cart_s')->name('front.cart_s');
  ...
  Route::get('/checkout_s/','Front\CheckoutController@checkout_s')->name('front.checkout_s');
  Route::get('/orderemail/','Front\CheckoutController@orderemail')->name('front.orderemail');
  ...
  Route::get('/checkout/payment/returnnew', 'Front\PaymentController@payreturnnew')->name('payment.returnnew');
