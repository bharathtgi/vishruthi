								...
								<div class="gocover"
									...
									<div class="row" >
										...
										<div class="col-lg-12">
											<ul class="list">
												<li>
													<input name="is_antic" type="checkbox" id="is_antic" value="1">
									...
									<div class="row" >
										...
										<div class="col-lg-12">
											<ul class="list">
												<li>
													<input class="checkclick1" name="chaintype_check" type="checkbox" id="check4"
														value="1">
									...
									<div class="row" >
										...
										<div class="col-lg-12">
											<ul class="list">
												<li>
													<input class="checkclick1" name="banglesize_check" type="checkbox" id="check4"
														value="1">
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="left-area">
												<h4 class="heading">
														{{ __('Product Tab Description') }}
												</h4>
											</div>
										</div>
										<div class="col-lg-12">
											<div class="text-editor">
												<textarea name="tab_desc" class="nic-edit-p"></textarea>
											</div>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-lg-12">
											<div class="text-editor">
												<textarea name="add_info" class="nic-edit-p"></textarea>
											</div>
										</div>
									</div>									
