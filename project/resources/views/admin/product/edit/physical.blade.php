...
@section('content')
                        ...
                        @include('includes.admin.form-both')
                                              ...
                                              @endforeach
												...
												<div class="row" >
													...
													<div class="col-lg-12">
														<ul class="list">
															<li>
																<input name="is_antic" type="checkbox" id="is_antic" value="1" <?php if ($data->is_antic == '1') { echo "checked"; } ?> >
																<label for="size-check">{{ __('Is Antic Product') }}</label>
															</li>
														</ul>
													</div>
												</div>
												...
												<div class="row" >
													...
													<div class="col-lg-12">
														<ul class="list">
															<li>
																<input class="checkclick1" name="chaintype_check" type="checkbox" id="check4" value="1" <?php if ($data->chaintype != '') { echo "checked"; } ?> >
																<label for="check4">{{ __('Allow Chain Type') }}</label>
															</li>
														</ul>
													</div>
												</div>
												<div class="<?php if ($data->chaintype == '' || $data->chaintype == null) { echo 'showbox'; } ?>">
													<div class="row">
														<div class="col-lg-12">
															<div class="left-area">
																<h4 class="heading">
														...
														<div class="col-lg-12">
															<div class="select-input-color" id="chaintype-section">
																@if(!empty($data->chaintype))
																	<?php $chaintype = explode(",",$data->chaintype); ?>
																	@foreach($chaintype as $key => $data1)
																		<div class="chaintype-area" style="margin-top: 10px;">
																			<span class="remove chaintype-remove"><i class="fas fa-times"></i></span>
																			<div class="input-group">
																				<input type="text" name="chaintype[]" value="{{ $chaintype[$key] }}" class="input-field" style="padding-left: 10px!important;"/>
																			</div>
																		</div>																	
																	@endforeach
																@else
																<div class="chaintype-area">
																	<span class="remove chaintype-remove"><i class="fas fa-times"></i></span>
																	<div class="input-group">
																		<input type="text" name="chaintype[]" class="input-field" style="padding-left: 10px!important;"/>
																	</div>
																</div>
																@endif
															</div>
															<a href="javascript:;" id="chaintype-btn" class="add-more mt-4 mb-3"><i
																	class="fas fa-plus"></i>{{ __('Add More Chain Type') }} </a>
														</div>
													</div>
												</div>
												<div class="row" >
													...
													<div class="col-lg-12">
														<ul class="list">
															<li>
																<input class="checkclick1" name="banglesize_check" type="checkbox" id="check4" value="1" <?php if ($data->banglesize != '') { echo "checked"; } ?> >
																<label for="check4">{{ __('Allow Bangles Size') }}</label>
															</li>
														</ul>
													</div>
												</div>
												<div class="<?php if ($data->banglesize == '' || $data->banglesize == null) { echo 'showbox'; } ?>">
													<div class="row">
														<div class="col-lg-12">
															<div class="left-area">
																<h4 class="heading">
														...
														<div class="col-lg-12">
															<div class="select-input-color" id="banglesize-section">
																@if(!empty($data->banglesize))
																	<?php $banglesize = explode(",",$data->banglesize); ?>
																	@foreach($banglesize as $key => $data1)
																		<div class="banglesize-area" style="margin-top: 10px;">
																			<span class="remove banglesize-remove"><i class="fas fa-times"></i></span>
																			<div class="input-group">
																				<input type="text" name="banglesize[]" value="{{ $banglesize[$key] }}" class="input-field" style="padding-left: 10px!important;"/>
																			</div>
																		</div>																	
																	@endforeach
																@else
																<div class="banglesize-area">
																	<span class="remove banglesize-remove"><i class="fas fa-times"></i></span>
																	<div class="input-group">
																		<input type="text" name="banglesize[]" class="input-field" style="padding-left: 10px!important;"/>
																	</div>
																</div>
																@endif
															</div>
															<a href="javascript:;" id="banglesize-btn" class="add-more mt-4 mb-3"><i
																	class="fas fa-plus"></i>{{ __('Add More Bangles Size') }} </a>
														</div>
													</div>
												</div>												
												<!-- Update for Vishruthi END -->
											...
											<div class="{{ $data->measure == null ? 'showbox' : '' }}">
												...
												</div>												<div class="row">													<div class="col-lg-12">														<div class="left-area">															<h4 class="heading">																	{{ __('Product Tab Description') }}															</h4>														</div>													</div>													<div class="col-lg-12">														<div class="text-editor">															<textarea name="tab_desc" class="nic-edit-p">{{$data->tab_desc}}</textarea>														</div>													</div>												</div>												<div class="row">													<div class="col-lg-12">														<div class="left-area">															<h4 class="heading">																	{{ __('Additional Information') }}															</h4>														</div>													</div>													<div class="col-lg-12">														<div class="text-editor">															<textarea name="add_info" class="nic-edit-p">{{$data->add_info}}</textarea>														</div>													</div>												</div>



												<div class="row">													<div class="col-lg-12">														<div class="left-area">															<h4 class="heading">																	{{ __('Product Buy/Return Policy') }}*															</h4>														</div>													</div>													<div class="col-lg-12">														<div class="text-editor">															<textarea name="policy" class="nic-edit-p">{{$data->policy}}</textarea>														</div>													</div>												</div>
