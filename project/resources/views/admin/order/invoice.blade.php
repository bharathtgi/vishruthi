            ...
            <div class="row invoice__metaInfo mb-4">
                <div class="col-lg-6">
                    <div class="invoice__orderDetails">
						...
						<span><strong>{{ __('Gst Number') }} :</strong> {{ $order->gst_num }}</span><br>
                                ...
                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0"
                                            ...
                                            <td>
                                               ...
                                               @if($product['color'])
												...
												@if(!empty($product['chaintype']))
													<p><strong>{{ __('Chain Type') }} :</strong> {{$product['chaintype']}}</p>
												@endif
												@if(!empty($product['banglesize']))
													<p><strong>{{ __('Bangle Size') }} :</strong> {{$product['banglesize']}}</p>
												@endif
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{number_format((float)($order->coupon_discount), 2, '.', '')}}</td>
                                        </tr>
                                        @endif
                                        <tr>
                                            <td colspan="1"></td>
                                            <td>{{ __('Total') }}</td>
                                            <td>{{$order->currency_sign}}{{ number_format((float)($order->pay_amount * $order->currency_value), 2, '.', '') }}
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
