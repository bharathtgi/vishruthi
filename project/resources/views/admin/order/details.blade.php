                            ...
                            <div class="row">
                              ...
                              <a href="javascript:;" data-toggle="modal" data-target="#confirm-delete" class="btn btn-info product-btn" id="license" style="padding: 5px 12px;"><i class="fa fa-eye"></i> {{ __('View License') }}</a>
                                            ...
                                            <td>
                                               ...
                                               <p><strong>{{ __('Qty') }} :</strong> {{$product['qty']}} {{ $product['item']['measure'] }}</p>												@if(!empty($product['chaintype']))													<p><strong>{{ __('Chain Type') }} :</strong> {{$product['chaintype']}}</p>												@endif												@if(!empty($product['banglesize']))													<p><strong>{{ __('Bangle Size') }} :</strong> {{$product['banglesize']}}</p>												@endif
