                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               </p>												@if(!empty($product['chaintype']))													<p><strong>{{ __('Chain Type') }} :</strong> {{$product['chaintype']}}</p>												@endif												@if(!empty($product['banglesize']))													<p><strong>{{ __('Bangle Size') }} :</strong> {{$product['banglesize']}}</p>												@endif
