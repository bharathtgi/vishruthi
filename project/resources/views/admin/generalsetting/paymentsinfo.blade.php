...
<hr>
                        ...
                        </div>                        <div class="row justify-content-center">							<div class="col-lg-3">								<div class="left-area">									<h4 class="heading">{{ __('GST Number') }} </h4>								</div>							</div>							<div class="col-lg-6">								<input type="text" class="input-field" placeholder="{{ __('GST Number') }}" name="gst_number" value="{{ $gs_dt->gst_number }}" >							</div>                        </div>
