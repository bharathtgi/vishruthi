<li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="emails" data-parent="#accordion">
            <li  style="display:none;"><a href="{{route('admin-mail-index')}}"><span>{{ __('Email Template') }}</span></a></li>
            <li><a href="{{route('admin-mail-config')}}"><span>{{ __('Email Configurations') }}</span></a></li>
            <li  style="display:none;"><a href="{{route('admin-group-show')}}"><span>{{ __('Group Email') }}</span></a></li>
        </ul>
    </li>    <li>        <a href="{{ route('admin-currency-index') }}" class=" wave-effect"><i class="fas fa-users-cog mr-2"></i>{{ __('Currencies') }}</a>    </li>
    <li  style="display:none;">
