...
class GeniusMailer
{
    ...
    public function sendAutoOrderMail(array $mailData,$order,$cart)
    {
        ...
        try{
            Mail::send('admin.email.mailbody',$data, function ($message) use ($objDemo,$order,$cart) {
                $message->from($objDemo->from,$objDemo->title);
                $message->to($objDemo->to);
                $message->subject($objDemo->subject);

                $fileName = public_path('assets/temp_files/'). $order->order_number .'.pdf';
