...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->type == "Physical")
        {
            ...
            // Chain Type Color
            if(empty($request->chaintype_check))
            {
                $input['chaintype'] = null;
            }
            else{
                $input['chaintype'] = implode(',', $request->chaintype);
            }
            // Chain Type Color
            if(empty($request->banglesize_check))
            {
                $input['banglesize'] = null;
            }
            else{
                $input['banglesize'] = implode(',', $request->banglesize);
            }			
