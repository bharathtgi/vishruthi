...
$("#chaintype-btn").on('click', function(){

    $("#chaintype-section").append(''+
                            '<div class="chaintype-area" style="margin-top: 10px;position: relative;">'+
...
$(document).on('click','.chaintype-remove', function(){ 

    $(this.parentNode).remove();
    if (isEmpty($('#chaintype-section'))) {
		$("#chaintype-section").append(''+
                            '<div class="chaintype-area" style="margin-top: 10px;position: relative;">'+
                                '<span class="remove chaintype-remove"><i class="fas fa-times"></i></span>'+
								'<div class="input-group">'+
...
// Chain Type Section Ends


// Bangles Size Section

$("#banglesize-btn").on('click', function(){

    $("#banglesize-section").append(''+
                            '<div class="banglesize-area" style="margin-top: 10px;position: relative;">'+
...
$(document).on('click','.banglesize-remove', function(){ 

    $(this.parentNode).remove();
    if (isEmpty($('#banglesize-section'))) {
		$("#banglesize-section").append(''+
                            '<div class="banglesize-area" style="margin-top: 10px;position: relative;">'+
                                '<span class="remove banglesize-remove"><i class="fas fa-times"></i></span>'+
								'<div class="input-group">'+
